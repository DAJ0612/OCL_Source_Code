...
disp('clustering performance on connect4 data set:');
Acc
ARI
NMI
%% Clustering for BM
...
disp('clustering performance on CR data set:');
Acc
ARI
NMI
